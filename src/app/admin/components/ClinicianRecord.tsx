  ...
  useEffect(() => {
    if (employeeRecord?.length > 0) {
      setFormData({
        ...
        companyAssignedTo: employeeRecord[0].companyAssignedTo || '',
        ...
        officeNumberOther: employeeRecord[0].officeNumberOther || '',
        ...
        companyEmailAddress: employeeRecord[0].companyEmailAddress || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 201) {
        toast.success('Employee Record details added successfully');
        mutate();
