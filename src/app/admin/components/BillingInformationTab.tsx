...
import BillingDetails from "@/app/customer/components/BillingDetails";
...
import CancelPlan from "@/app/customer/billing-insurance/_components/CancelPlan";
  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-[15px] mt-[30px]  mb-[30px] lg:gap-[24px] lg:mt-[50px] lg:mb-[45px]">
        ...
        {!rowId && <div className="bg-[#FFBBCD]  flex flex-col carg-bg rounded-[10px] py-6 px-[15px] lg:px-[30px]">
